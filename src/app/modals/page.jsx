  ...
  return (
    <main className="modal">
            ...
            <section className="conteudo">
                ...
                <Image src="/img5.png" alt="Guincho Leve" width={600} height={300} priority={true}/>
                    <h1>Guincho Leve</h1>
                    <p>
                ...
                <div className="modals">
                <Image src="/img4.png" alt="Guincho Pesado" width={600} height={300} priority={true}/>
                ...
                <div className="modals">
                <Image src="/img6.png" alt="Guincho Plataforma" width={600} height={300} priority={true}/>
                ...
                <div className="modals">
                <Image src="/img10.png" alt="Guincho para Veículos Especiais" width={600} height={300} priority={true}/>
                ...
                <div className="modals">
                <Image src="/img1.png" alt="Guincho 24 Horas" width={600} height={300} priority={true}/>
                ...
                <div className="modals">
                <Image src="/img9.png" alt="Guincho para Veículos 4x4" width={600} height={300} priority={true}/>
                ...
                <div className="modals">
                <Image src="/img2.png" alt="Reboque para Concessionária" width={600} height={300} priority={true}/>
